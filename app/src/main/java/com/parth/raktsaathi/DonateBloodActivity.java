...
public class DonateBloodActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        donate.setOnClickListener(v -> donateBlood());
    }
    ...
    private void donateBlood() {
        ...
        client.post(Urls.BloodDonorWebServiceAddress, params,
                new AsyncHttpResponseHandler() {

                    @Override
                    public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                        Toast.makeText(DonateBloodActivity.this, "Donate Successful", Toast.LENGTH_SHORT).show();
                    }

                    @Override
                    public void onFailure(int statusCode, Header[] headers, byte[] responseBody, Throwable error) {
                        Toast.makeText(DonateBloodActivity.this, "Failed", Toast.LENGTH_SHORT).show();
                    }
                });
    }
}